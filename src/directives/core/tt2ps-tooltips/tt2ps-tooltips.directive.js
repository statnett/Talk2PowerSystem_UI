...
import './tt2ps-tooltips.directive.scss';
import {decodeHTML} from "../../../app";

const TooltipModule = angular
    .module('tt2ps.core.directives.tt2ps-tooltip', []);
TooltipModule
    .directive('tt2psTooltip', tt2psTooltip);

tt2psTooltip.$inject = ['$timeout', '$compile'];
 ...
 */
function tt2psTooltip($timeout, $compile) {
    return {
        restrict: 'A',
        scope: {
            tt2psTooltip: '@',
        ...
        link: function ($scope, element, attrs) {
            ...
            $scope.createTooltip = function (event) {
                if (attrs.tt2psTooltip) {
                    ...
                    $scope.updateTooltip(attrs.tt2psTooltip);
            ...
            $scope.$watch('tt2ps-tooltip', function (newTitle) {
