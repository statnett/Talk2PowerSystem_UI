import './editable-content.directive.scss';
import template from './editable-content.directive.html';

const modules = [];

const EditableContentModule = angular
    .module('tt2ps.directives.core.editable-content', modules);
EditableContentModule
    .directive('editableContent', EditableContentDirective);

EditableContentDirective.$inject = [];

/**
 * @ngdoc directive
 * @name EditableContentDirective
 * @module tt2ps.directives.core.editable-content
 * @restrict E
 * @description
 ...
 */
function EditableContentDirective() {
    return {
        restrict: 'E',
        require: 'ngModel',
        scope: {
...
export default EditableContentModule;
